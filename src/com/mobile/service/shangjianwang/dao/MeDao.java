...
public interface MeDao {
	 ...
	 * @throws Exception
	 */
	int getZan(Map<String, Object> attrMap) throws Exception;
	...
	boolean recharge(String order) throws Exception;
	...
	//获取资讯列表
	List<Map<String, Object>> getnewsdatalist(String offset, String limit)
			throws Exception;

	//获取资讯详情
	Map<String, Object> getnewsdetail(String newid) throws Exception;

	//获取拍卖列表
	List<Map<String, Object>> getpaimailist(String offset, String limit) throws Exception;
	
	//获取拍卖详情
	Map<String, Object> getpaimaiDetail(String paimaiID) throws Exception;

	//是否已购买该书籍
	boolean isbuythisbook(String userID, String bookID) throws Exception;
	
	boolean isfreebook(String bookID) throws Exception;
	
	List<Map<String, Object>> getallMember(String offset, String limit,String key) throws Exception;
	
	
	Map<String, Object> Province(String ProID) throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean sendComment(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getBookComments(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getiapPriceList(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	Map<String, Object> buyWithBook(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getBuyedBooks(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getPurchaseLogs(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	Map<String, Object> becomeFans(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getMemberList(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getFansList(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean sendTalk(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean deleteTalk(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean commentTalk(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean zanTalk(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	Map<String, Object> getTalkDetail(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getZansWithTalk(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getCommentsWithTalk(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getTalkList(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getGroupList(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getAuthorList(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	Map<String, Object> getAuthorDetail(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getNewsList(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	Map<String, Object> getNewsDetail(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getBannerList(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getCityList(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getGoodsList(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	Map<String, Object> getGoodDetail(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean sendGoods(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean goodPay(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getGoodPayList(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean finishGoodPay(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean changeGoodStatus(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	Map<String, Object> sendIdCar(HttpServletRequest request)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	Map<String, Object> getIdcarStatus(HttpServletRequest request)
			throws Exception;
